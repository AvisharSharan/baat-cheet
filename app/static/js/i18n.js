...
const i18nDict = {
  en: {
    ...
    "set.tab_acc": "Account",
    "set.mom_provider": "Minutes Provider",
    "set.mom_provider_hint": "Choose where generated minutes are drafted",
    ...
    "set.hosted_model": "Hosted Model",
    "set.hosted_model_hint": "Model name sent in the hosted API request",
    ...
    "set.gpu": "GPU Layers",
    "set.gpu_hint": "Defaults to 35 GPU-offloaded layers (0 = CPU only)",
    "set.speech_engine": "Speech Engine",
    "set.speech_engine_hint": "Choose who handles transcription and diarization",
    "set.trans_provider": "Transcription Engine",
    "set.trans_provider_hint": "Used only when Speech Engine is Open source",
    ...
    "set.sarvam_model": "Sarvam Model",
    "set.sarvam_model_hint": "Uses SARVAM_API_KEY from your environment",
    "set.sarvam_mode": "Sarvam Mode",
    "set.sarvam_mode_hint": "Use Transcribe with hi-IN for Hindi script output",
    "set.sarvam_lang": "Sarvam Language",
    "set.sarvam_lang_hint": "Use hi-IN for Hindi script, en-IN for English, or another Sarvam language code",
  ...
  hi: {
    ...
    "set.gpu": "GPU लेयर्स",
    "set.gpu_hint": "डिफ़ॉल्ट रूप से 35 GPU लेयर्स ऑफ़लोड होती हैं (0 = केवल CPU)",
    "set.speech_engine": "Speech Engine",
    "set.speech_engine_hint": "Transcription और diarization कौन करेगा",
    "set.trans_provider": "Transcription Engine",
    "set.trans_provider_hint": "सिर्फ Open source engine के लिए",
    ...
    "set.indic_device_hint": "600M parameters; GPU is recommended",
    "set.sarvam_model": "Sarvam Model",
    "set.sarvam_model_hint": "SARVAM_API_KEY आपके environment से उपयोग होता है",
    "set.sarvam_mode": "Sarvam Mode",
    "set.sarvam_mode_hint": "Hindi script output के लिए Transcribe और hi-IN रखें",
    "set.sarvam_lang": "Sarvam Language",
    "set.sarvam_lang_hint": "Hindi script के लिए hi-IN, English के लिए en-IN, या कोई Sarvam language code",
